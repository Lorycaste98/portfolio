...
function WorkItem({ period, title, details }) {
  return (
    <ul className="ml-4 flex flex-col relative border-l border-stone-200 dark:border-blue-950">
      <li className="mb-10 ml-2 cursor-auto">
        ...
        <p className="flex flex-wrap gap-2 flex-col md:flex-row items-start md:items-center justify-start text-xs md:text-sm md:py-2">
          <span className="inline-block px-2 py-1 font-semibold bg-[#000051] dark:bg-stone-200 text-white dark:text-[#000051] rounded-md text-xl lg:text-2xl">
            {title}
          </span>
